...
const EditText = () => {
    ...
    const fetchDocs = async () => {
        const res = await fetch(`https://texteditor-backend-sigma.vercel.app/api/v1/textarea/edittext/${id}`, {
            method: 'GET',
            headers: {
    ...
    useEffect(() => {
        ...
        socket.current = io('https://texteditor-backend-sigma.vercel.app')
    ...
    const HandleUserNameChange = async (e) => {
        ...
        const res = await fetch(`https://texteditor-backend-sigma.vercel.app/api/v1/auth/search-user/?search=${username}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token'),
      ...
      const HandleSharingForm = async (e) => {
        e.preventDefault()
        const res = await fetch(`https://texteditor-backend-sigma.vercel.app/api/v1/textarea/share-text/${id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
            'auth-token': localStorage.getItem('token'),
      ...
      const RemoveAccess = (user) => {
        return async (e) => {
          e.preventDefault()
          const res = await fetch(`https://texteditor-backend-sigma.vercel.app/api/v1/textarea/remove-access`, {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
              'auth-token': localStorage.getItem('token'),
